...
class ArmEnv(object):
    ...
    def update_state_all(self):
        ...
        # state
        s = np.concatenate((a1xyz_/200 , finger/200, dist1 , dist2, [1. if self.on_goal else 0.])) #/200? 是否需要
    ...
    def reset(self):   #  reset in train
        ...
        self.goal['x'] = 60  # 将球坐标转换为笛卡尔坐标 x
        self.goal['y'] = 0 # 将球坐标转换为笛卡尔坐标 y
        self.goal['z'] = 60 # 将球坐标转换为笛卡尔坐标 z
...
if __name__ == '__main__':
    ...
    for _ in range(2000):
        ...
        print(f"xyz = {s[3]*200 , s[4]*200 ,s[5]*200}")
        traj_all.append((s[3]*200 , s[4]*200 ,s[5]*200))
